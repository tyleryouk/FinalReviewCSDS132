...
public class Point2D2answer {
   ...
   */
  public Point2D2answer(double x, double y) {
    this.x = x;
    this.y = y;
  }
  ...
  private class CompareByDistanceFromHere implements Comparator<Point2D> {
     ...
     */
    public int compare(Point2D2answer point1, Point2D2answer point2) {
      double point1Dist = euclideanDistance(point1, Point2D2answer.this);
      double point2Dist = euclideanDistance(point2, Point2D2answer.this);
